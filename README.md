...
| Domain | Focus | Status |
|:---:|---|:---:|
| Quantum ML | Hybrid quantum-classical algorithms, kernel methods | Active |
| Koopman Theory | DMD-based dynamical system analysis | Active |
| PINNs | Physics-constrained latent ODEs for machinery | Active |
| Predictive Maintenance | Incipient fault early warning systems | Active |
| Transformers | Temporal attention for degradation sequences | Learning |
| Hardware QPU | Real quantum hardware deployment | Planned |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:2d2d9e,50:1a1a6e,100:0a0a2e&height=120&section=footer&animation=fadeIn" width="100%"/>
